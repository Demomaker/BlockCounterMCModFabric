...
public class HelpCommand extends ServerCommand {
  ...
  public static ServerCommandArgumentBuilder getDefaultServerCommandFormat(ServerCommand Command) {
  ...
  public static ServerCommandArgumentBuilder getTranslatedServerCommandFormat(ServerCommand Command) {
